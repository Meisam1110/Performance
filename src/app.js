...
(function () {
   ...
   *
   * Same geometry as the supplied artwork (128 x 70): a black plate with the
   * Persian wordmark over the group mark, both reversed out of it. The bar it
   * sits on is nearly black, so a hairline keeps the plate's edge visible —
   * without it the mark reads as loose white text.
   */
  function logoMark() {
    var svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.setAttribute('viewBox', '0 0 128 70');
    ...
    svg.innerHTML =
      '<rect x="1.2" y="1.2" width="125.6" height="67.6" rx="16"' +
      ' fill="#000000" stroke="rgba(255,255,255,.45)" stroke-width="2.4"/>' +
      ...
      '<text x="64" y="37" text-anchor="middle" fill="#ffffff" direction="rtl"' +
      ' style="unicode-bidi:plaintext"' +
      ' font-family="MTN Irancell, Tahoma, sans-serif" font-weight="700"' +
      ' font-size="25">ایرانسل</text>' +
      '<text x="64" y="60" text-anchor="middle" fill="#ffffff"' +
      ' font-family="Arial, Helvetica, sans-serif" font-weight="700"' +
      ' font-size="15" letter-spacing="1.3">MTN</text>';
    return svg;
  }
