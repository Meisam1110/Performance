...
var html = [
  ...
  '<!--',
  '  KARANEH MANAGEMENT SYSTEM — HR edition, single-file build',
  '  Generated by tools/build.js from the modules under src/.',
  '  Edit the sources, not this file, then re-run the build.',
  '',
  '  This is the file HR works in. Division-head files are produced from',
  '  inside it (پرسنل → تولید فایل معاون بخش): each is a copy of this page',
  '  carrying only that division\'s people and opening in the head\'s role.',
  '',
